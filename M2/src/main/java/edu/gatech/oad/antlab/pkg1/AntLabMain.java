 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Samuel Bretz");
		  toPrint += p1.toString("sbretz3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("John Murphy");
		  toPrint += p2.toString("jmurphy83");
		  //Person3 replace P3 with your named
		  //and gburdell3 with your gt id
          Person3 p3 = new Person3("Jonathan King");
          toPrint += p3.toString("jking88");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Eduardo Vargas");
          toPrint += p4.toString("evargas9");
          //Person5 replace P4 with your name
          //and gburdell5 with your gt id
          Person5 p5 = new Person5("Cesar Porcayo");
          toPrint += p5.toString("cporcayo3");
